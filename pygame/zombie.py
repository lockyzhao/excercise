...
while True:
    ...
    while True: # the game loop runs while the game part is playing
        shoot=False
        for z in zombies:
            if z['rect'].colliderect(pygame.Rect(200,30,50,WINDOWHEIGHT-100)): shoot =True
        # for z in newKindZombies:
        #     if z['rect'].colliderect(pygame.Rect(200,30,50,WINDOWHEIGHT-100)): shoot =True
        ...
        for b in bullets:
            #print b['rect'].right
            if b['rect'].right>=WINDOWWIDTH-20:                
                bullets.remove(b)
        #bullets=[b for b in bullets if b['rect'].right<WINDOWWIDTH-10]
